...
Welcome to the `R` package `novelforestSG`! It contains the data input and downloadable `brms` model output described in
...
The model object is too large (16.5 MB) to come with the package, but the `download_model` function can download the model from our [GitHub development website](https://github.com/hrlai/novelforestSG) for you: see `?download_model` for a worked example.
