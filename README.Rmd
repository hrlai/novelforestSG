...
While releasing additional data between v1.2.1 to v1.3.0, we realised that some observations were removed by mistake in the older dataset used in Lai et al. (2021). These omitted data are now included in >v1.3.0. We repeated the analysis using the corrected data in v1.3.0 and obtained extremely similar findings as reported Lai et al. (2021), which is reassuring! Please feel free to contact us if you have any concern.
